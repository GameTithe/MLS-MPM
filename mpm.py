...
def initialise():  
    ...
    for i in range(particle_count):
        ...
        particles[i].mass = 1.0 #ti.random()
...
def Simulate():
    ...
    for i in range(particle_count): 
        ...
        #print(p.x, ", ", cell_idx, ",", p.x.y - cell_idx.y)
        #print(p.v)
        # Quadratic B-Spline
    ...
    for i in range( particle_count ):
        ...
        weights[0] = 0.5 * ti.pow(0.5 - cell_diff, 2.0)
        weights[1] = 0.75 - ti.pow(cell_diff, 2.0)
        weights[2] = 0.5 * ti.pow(0.5 + cell_diff, 2.0)
